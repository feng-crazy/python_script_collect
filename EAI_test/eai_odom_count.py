...
# @Author  : hedengfeng
# @Site    : 
# @File    : eai_publish_pulse_count.py
# @Software: EAI_test
# @description:
...
class EaiOdometryPublisher(object):
    ...
    def publish_pulse_count(self, pulse_count):
        public_topic = "Odometry"
        self.pub_socket.send_multipart([public_topic.encode(), pulse_count.encode()])
        print(pulse_count)
    ...
    def read_pulse_count(self):
        ...
        if pulse_count_list[0]=='0' and pulse_count_list[1]=='0':
            return
        self.publish_pulse_count('{} {} {}'.format(pulse_count_list[0], pulse_count_list[1], time.time()))
...
if __name__ == "__main__":
    ...
    eai_publisher = EaiOdometryPublisher(left_wheel, right_wheel, wheel_count)
    eai_publisher.start()
